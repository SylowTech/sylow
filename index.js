...
if (!module.parent) {
  ...
  Server
    ...
    .then((server) => {
      if (server) {
        if (config.domain) {
          console.log('\x1b[33m', 'SY_DOMAIN was set, but I already have an authoritative server that I must use. To edit the autoritative server, please use the CLI.'); //eslint-disable-line no-console
        }
